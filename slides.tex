...
\item \hyperlink{sec:approach}{Approaches}
...
\begin{itemize}
  ...
  \begin{tabular}{l||c}
    ...
    \toprule
    \textit{The \textcolor{brown}{monkey} ate the \textcolor{myyellow}{banana}. Because \textcolor{orange}{it} was hungry.} & \texttt{er} \\
    \textit{The \textcolor{brown}{monkey} ate the \textcolor{myyellow}{banana}. Because \textcolor{orange}{it} ripe.} & \texttt{sie} \\
    \textit{The \textcolor{brown}{monkey} ate the \textcolor{myyellow}{banana}. Because \textcolor{orange}{it} was tea-time.} & \texttt{es}
  \end{tabular}
  \end{center}
  \end{table}
  \item[]
  \item Use other sentences as context information to improve translation process
  \begin{itemize}
    \item co-reference
    \item inter-sential anaphora (e.g. pronouns referring to mentioned entities)
  \end{itemize}
\end{itemize}
\vfill
...
\begin{itemize}
  ...
  \item Use other sentences as context information to improve translation process
  \begin{itemize}
    \item improve translation of co-referenced words
    \item 
  \end{itemize}
\end{itemize}
\vfill
